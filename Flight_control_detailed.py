...
def limit_texts():
    ...
    ticket_number = float(ticket_number)
    hand_bag = hand_bag_entry.get()
    hand_bag = float(hand_bag)
...
message_label_1 = Label(simple_screen_4, text= "Give your ticket number:", ).place(x=labels_x,y=10)
ticket_number_entry = Entry(simple_screen_4, width=20)
ticket_number_entry.place(x=enterys_x, y=10)

hand_bag_label = Label(simple_screen_4, text= "Enter your handbag weight in KG:").place(x=labels_x,y=60)
hand_bag_entry = Entry(simple_screen_4,width=20)
hand_bag_entry.place(x=enterys_x, y=60)

liquid_label = Label(simple_screen_4, text= "Enter your liquid quantity in L:").place(x=labels_x,y=110)
liquid_entry = Entry(simple_screen_4,width=20)
liquid_entry.place(x=enterys_x, y=110)

enter_button = Button(simple_screen_4, text="Enter",command= lambda :limit_texts()).place(x= 200 , y=150, height=30, width=100)
