...
def body_index_calculate():
    height = height_entry.get()  # It is allows us to get the number in the entry
...
kilogram_entry.place(x=150,y=10)  # If you write the .place function to previous line .get is not working.
